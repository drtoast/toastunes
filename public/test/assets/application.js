...
(function() {
  window.tt = {
    ...
    debug: true,
    init: function() {
      this.router = new tt.Routers.Application;
      this.views.application = new tt.Views.Application;
      this.views.album = new tt.Views.Album;
      this.playlist = new tt.Collections.Albums;
...
(function() {
  tt.Views.Album = Backbone.View.extend({
    el: '#stage',
    template: function() {
      return h1("hello album");
    },
    render: function() {
      $(this.el).html(CoffeeKup.render(this.template));
      return this;
    }
  });
}).call(this);
...
(function() {
  tt.Routers.Application = Backbone.Router.extend({
    ...
    index: function() {
      return tt.log("router: index");
    },
    albums: function() {
      var album_view;
      tt.log("router: album");
      album_view = new tt.Views.AlbumIndex;
      return album_view.render();
    },
    album: function() {
      tt.log("router: album_show");
      return tt.views.album.render();
    }
  });
}).call(this);
